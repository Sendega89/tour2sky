...
class ImageGallery extends React.Component {
    ...
    prevHandler = event => {
        var slider = document.getElementById('slider-img-container');
        var index = this.state.currentIndex === 0 ? 5 : this.state.currentIndex - 1;

        this.slideTransition(slider);

        this.setState(prevState => ({
            currentIndex:
                prevState.currentIndex === 0 ? 5 : prevState.currentIndex - 1
        }));
    };

    nextHandler = event => {
        var slider = document.getElementById('slider-img-container');
        var index = this.state.currentIndex === 5 ? 0 : this.state.currentIndex + 1;

        this.slideTransition(slider);

        this.setState(prevState => ({
            currentIndex:
                prevState.currentIndex === 5 ? 0 : prevState.currentIndex + 1
        }));
    };
